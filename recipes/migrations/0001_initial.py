    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('measurement', models.CharField(default='', max_length=200)),
            ],
        ),
        migrations.CreateModel(
            name='Recipe',
            fields=[
                ...
                ('category', models.CharField(blank=True, choices=[('Breakfasts', 'Breakfasts'), ('Appetizers', 'Appetizer'), ('Soups', 'Soups'), ('Main_Dishes', 'Main Dishes'), ('Salads', 'Salads'), ('Desserts_and_PASTRY', 'Desserts & Pastry'), ('Sauces', 'Sauces'), ('Drinks', 'Drinks')], max_length=64)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ingredients', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='total_ingredients', to='recipes.ingredients')),
